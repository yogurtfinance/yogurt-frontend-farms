  ...
  return (
    <Modal title={TranslateString(450, 'Enter amount of tickets to buy')} onDismiss={onDismiss}>
      <TicketInput
        ...
        max={fullBalance}
        symbol="TICKET"
        availableSymbol="BCTRM"
      />
      <div>
        <Tips>{TranslateString(456, 'Your amount must be a multiple of 10 BCTRM')}</Tips>
      ...
      <div>
        <Announce>
          {TranslateString(
            478,
            'Ticket purchases are final. Your BCTRM cannot be returned to you after buying tickets.',
          )}
        </Announce>
        <Final>{TranslateString(460, `You will spend: ${cakeCosts(val)} BCTRM`)}</Final>
      </div>
      <ModalActions>
